...
Route::prefix('projects')->group(function () {
    ...
    Route::get('search/{keyword}', [ProjectController::class, 'ApiSearch'])->name('ApiSearch');
    Route::get('external-books',  [ProjectController::class, 'ApiSearch'])->name('books.external');
});
